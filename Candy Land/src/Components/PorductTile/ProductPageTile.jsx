...
export default function ProductPageTile({ item, isItemInList }) {
  let { wishlistItems, cartItems, handleToggleItem } =
    ...
    <section className="product-page-card pt-4">
      <div className="col-5 product-image-div">
        ...
        <div className="d-flex">
          <div className="product-page-other-images"></div>
          <div className="product-page-other-images"></div>
          <div className="product-page-other-images"></div>
        </div>
      </div>
      ...
      <div className="col text-start product-card-body">
        ...
        <div className="col-9 m-0">
          {" "}
          <hr className="col-9" style={{ width: "100%" }}></hr>
        </div>
        <div>{item.weight}</div>
        ...
        <div>
          <h5 className="homogeneous-filter-controls-head">
            ...
            <FontAwesomeIcon
              className={
                dropDescription ? "hide-drop-icon-active" : "hide-drop-icon"
              }
                    ...
                    {[...Array(5)].map((_, index) => {
                      ...
                      return (
                        <label key={index}>
                          ...
                          <FontAwesomeIcon
                            icon={
                              currentRate <= x.rating ? faStar : faStarBorder
                            }
                            color="#EA3D32"
                          />
                        </label>
